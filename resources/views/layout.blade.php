<!DOCTYPE html>
<html lang="en" class="js-priorityNav">
    <head>
        <meta charset="utf-8">
        ...
        <!-- Fonts -->
        <!-- <link href="/css/fontgoogleapi.css" rel="stylesheet" type="text/css"> -->
        <!-- Google fonts -->
        ...
        <link rel="stylesheet" type="text/css" href="/css/priority-nav-core.css">
