...
<div class="" style="float:right;margin-top:13%;">
  <div class="btn-group-vertical">
    <a href="#" type="button" class="btn btn-primary btn-lg" style="background-color: rgba(0, 108, 109, 1);">关于迦途</a><p></p>
...
<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" style="float:right;">
  <div class="container">
    <div class="comWrapper" style="width:90;margin: 0;padding-top: 7%;min-height: 680px;text-shadow: 1px 1px 1px #fff;">
        <div  style="font-size:18px;line-height: 2;"><p>&nbsp;&nbsp;&nbsp;&nbsp;迦途国际（加拿大）有限公司，是一家以加拿大优质生态资源、人文历史与开放的商业环境为平台。结合中加两国人文互动、经济经贸发展的新趋势，集文化交流、新型旅游、教育、医疗养老、休闲养生、居家置业、现代物流、经贸交流、商业策划等领域为一体的综合性跨国集团公司。
