...
<div class="summerContainer" style="color:#333333;">
  <div class="seasonHeader">
    <span class="title1" style="color:#68B02E; padding-left:10%;">迦途·夏</span>
    <br>
    <span class="title2" style="padding-left:15%;">&ndash; &ndash;蜜月湖&ndash;沃萨加海滩七日游</span>
  </div>
  ...
  <div class="scroller">
    ...
    <div class="innerScrollArea" id="fullContainer">
      <ul>
        <li><a class="fullsizable" href="/images/jiatu/summer/1.jpg"><img src="/images/jiatu/summer/1.jpg" /></a></li>
        <li><a class="fullsizable" href="/images/jiatu/summer/2.jpg"><img src="/images/jiatu/summer/2.jpg" /></a></li>
        <li><a class="fullsizable" href="/images/jiatu/summer/3.jpg"><img src="/images/jiatu/summer/3.jpg" /></a></li>
        <li><a class="fullsizable" href="/images/jiatu/summer/4.jpg"><img src="/images/jiatu/summer/4.jpg" /></a></li>
        <li><a class="fullsizable" href="/images/jiatu/summer/5.jpg"><img src="/images/jiatu/summer/5.jpg" /></a></li>
        <li><a class="fullsizable" href="/images/jiatu/summer/6.jpg"><img src="/images/jiatu/summer/6.jpg" /></a></li>
      </ul>
    </div>
...
<div class="row" style="margin: 3vw;background-color: rgba(255, 255, 255, 0.9);padding: 2vw">
            ...
            <div class=" col-md-8 col-sm-8 col-lg-8 col-xs-12" >
                ...
                {{ csrf_field() }}
                    <div class="row">
                      <input type="hidden" name="title" value="迦途·夏– –蜜月湖–沃萨加海滩七日游">
...
<div class="info">
  ...
  <div class="info">
    <ul>
      ...
      <li class="content3">
        <p> 第四天: （蜜月湖—沃萨加比奇海滩）
        <p>抵达Wasaga沙滩，在沙滩享受烧烤、游泳、排球等各种沙滩活动。
      </li>
      <li class="content3">
        <p> 第五天: （休伦湖）
        <p>休伦湖畔垂钓。
